...
export const updateOne = async ({model, filter = {}, data = {},options = {} , select = "", populate=[]} )=> {
...
export const findByIdAndDelete = async ({model, id = "", select = "", populate=[]} )=> {
    ...
    const document = await model
    .findByIdAndDelete(id,data,options)
    .select(select)
    .populate(populate)
    return document;
}

export const findOneAndDelete = async ({model, id = "", select = "", populate=[]} )=> {

    const document = await model
    .findOneAndDelete(id,data,options)
    .select(select)
    .populate(populate)
    return document;
}
